...
Syntax uniqueness doesn’t exist and doesn't matter. Every language shares some commonality with others: braces for blocks, parentheses for calls, and colons or keywords for types. This is done on purpose. If someone picks up your language, the last thing they want to find out is you've replaced curly braces for blocks with square brackets just to be different (sorry esolangs). Don't fight decades of muscle memory.
